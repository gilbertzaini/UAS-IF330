...
<div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
        <div class="p-4 sm:p-8 bg-white shadow sm:rounded-lg">
            <div class="max-w-xl">
                <form method="post" action="{{ route('doctor.update', ['id'=>$doctor->id]) }}" class="mt-6 space-y-6">
                    @csrf
                    @method('patch')
                    ...
                    <div>
                        ...
                        <x-text-input id="tanggalLahir" type="text" name="foto" class="mt-1 block w-full" :value="old('foto', $doctor->foto)" required autocomplete="foto" />
